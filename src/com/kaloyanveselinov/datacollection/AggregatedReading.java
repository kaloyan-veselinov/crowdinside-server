...
public class AggregatedReading {
    ...
    private void printReadingToCSV(CSVPrinter csvPrinter, String type) throws IOException {
        csvPrinter.printRecord(timestamp.getTime(),
                ...
                acceleration.meanVector.getNorm(), acceleration.descriptiveStatistics.getVariance(),
                ...
                magnetometer.meanVector.getNorm(), magnetometer.descriptiveStatistics.getVariance(),
                ...
                gyroscope.meanVector.getNorm(), gyroscope.descriptiveStatistics.getVariance(),
    ...
    public double getMagnetometerVariance() {
        return magnetometer.descriptiveStatistics.getVariance();
    }
